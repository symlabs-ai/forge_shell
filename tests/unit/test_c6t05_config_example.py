...
DADO ~/.forge_shell/ não existe
QUANDO ConfigLoader.ensure_config_dir() é chamado
ENTÃO ~/.forge_shell/ é criado
ENTÃO ~/.forge_shell/config.yaml.example é criado com conteúdo válido YAML
"""
import pytest
import yaml
