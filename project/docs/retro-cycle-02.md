...
- **`sym_shell attach` ainda stub**: task P1 não coberta — relay WebSocket completo fica para cycle-03.
...
- **cycle-03**: Relay WebSocket real (`asyncio + websockets`), `sym_shell attach` wired, NL Mode ao vivo (teste com ollama local), `pip install -e .` + smoke do binário PyInstaller
